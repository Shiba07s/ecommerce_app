...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Object> handlerOrderException(OrderNotFoundException ooex, WebRequest request) {

		Map<String, Object> body = new HashMap<>();
		body.put("timestamp", LocalDateTime.now());
		body.put("status", HttpStatus.NOT_FOUND.value());
		body.put("error", "User Not Found");
		body.put("message", ooex.getMessage());
		body.put("path", request.getDescription(false));

		return new ResponseEntity<Object>(body, HttpStatus.NOT_FOUND);
	}
	@ExceptionHandler(value = OrderItemNotFoundException.class)
	public ResponseEntity<Object> handlerOrderItemException(OrderItemNotFoundException oex, WebRequest request) {
		
		Map<String, Object> body = new HashMap<>();
		body.put("timestamp", LocalDateTime.now());
		body.put("status", HttpStatus.NOT_FOUND.value());
		body.put("error", "User Not Found");
		body.put("message", oex.getMessage());
		body.put("path", request.getDescription(false));
